							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								?>
									...
									<tr>
										...
										echo $x=date('H:i',strtotime($ttme['start_time']));
										echo $y=date('H:i');
										 $cur=date('Y-m-d');
										//echo $date;
										if($cur<$date){
										...
										<td>
											...
											echo date('h:i A',strtotime($ttme['start_time']))." ".$ttme['name'];?> Show
										</td>
										<?php  }elseif($cur==$date){
											if($x>$y){ ?>
<td>
...
<td colspan="2"><?php if($avl[0]==$screen['seats']){?><button type="button" class="btn btn-danger" style="width:100%">House Full</button><?php } else { ?>
                                 ...
                                 <?php }else{ ?>
									...
									<td colspan="2"><button type="button" class="btn btn-danger" style="width:100%">No Shows</button><td>
							<?php	 }}?>
									</tr>
						<table>
							<tr>
